...
const UploadDropZone = () => {
  ...
  return (
    // <div className='max-md:px-5"> flex flex-col items-center justify-center rounded-2xl bg-white px-20 py-8 max-md:max-w-full'>
    //   <img
    ...
    //       <p className="text-center text-base font-medium leading-6 text-black text-opacity-80">
    //         Drag your files or folders to this area to upload
    //       </p>
    //       <p className="mt-1 text-center text-sm leading-5 text-black text-opacity-50">
    //         None of the files will be uploaded to a server. Files will be saved
    //         in a browser database.
    //       </p>
    //     </Upload.Dragger>
